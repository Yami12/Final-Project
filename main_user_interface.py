...
def device_frame_ok():
     driver.initialize(entry_owner_name.get(), entry_platform_name.get(), entry_platform_version.get(), entry_device_name.get(),entry_app_package.get(), entry_app_activity.get(), entry_apk_file.get())
...
#define 8 frames, each represents a screen
...
Label(device_frame, text="owner name:", width=20, font=("bold", 10)).place(x=80, y=80)
entry_owner_name = Entry(device_frame)
entry_owner_name.place(x=240, y=80)
entry_owner_name.insert(0, 'father')
entry_owner_name.configure(state="disabled")

Label(device_frame, text="platform name:", width=20, font=("bold", 10)).place(x=80, y=110)
entry_platform_name = Entry(device_frame)
entry_platform_name.place(x=240, y=110)
entry_platform_name.insert(0, 'Android')

Label(device_frame, text="platform version:", width=20, font=("bold", 10)).place(x=80, y=140)
entry_platform_version = Entry(device_frame)
entry_platform_version.place(x=240, y=140)
entry_platform_version.insert(0, '8.0.0')

Label(device_frame, text="device name:", width=20, font=("bold", 10)).place(x=80, y=170)
entry_device_name = Entry(device_frame)
entry_device_name.place(x=240, y=170)
entry_device_name.insert(0, 'My HUAWEI')

Label(device_frame, text="app package:", width=20, font=("bold", 10)).place(x=80, y=200)
entry_app_package = Entry(device_frame)
entry_app_package.place(x=240, y=200)
entry_app_package.insert(0, 'com.keepers')

Label(device_frame, text="app activity:", width=20, font=("bold", 10)).place(x=80, y=230)
entry_app_activity = Entry(device_frame)
entry_app_activity.place(x=240, y=230)
