...
if __name__ == '__main__':
    ...
    try:
        ...
        uf.print_log("{\\rtf1\\ansi\deff0{\colortbl;\\red0\green0\\blue0;\\red255\green0\\blue0;\\red0\green128\\blue0;}}")#defines the logs colors
        ...
        if sys.argv[1] == sl.FEATURE_TEST: # feature test
            ...
            driver.tests_folders_names = sys.argv[3]
